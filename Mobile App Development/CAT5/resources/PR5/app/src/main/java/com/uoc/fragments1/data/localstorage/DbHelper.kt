...
class DbHelper(context: Context) : SQLiteOpenHelper(context, "cat2", null, 1) {
    ...
    override fun onCreate(db: SQLiteDatabase) {
        ...
        try {
            ...
            //BEGIN-CODE-UOC-2
            /*
            The code copies the initial images from the resources to the application files area.
            It also creates a directory structure inside the application files area:
            media/seminar/
            media/item/


            MoveResources quality:90
            */
